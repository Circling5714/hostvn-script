...
Môi trường: Proxmox LXC 10.10.10.100, 4GB RAM / 2 cores, unprivileged. Lưu ý: template gốc là Ubuntu 24.10 lai sources noble → đã ép đồng bộ toàn bộ userland về **noble 24.04 thật** (pin 1001 + downgrade 239 gói) trước khi test. Test tự động hoá: cài trong tmux + daemon tự trả lời 5 prompt + monitor log từ xa.
